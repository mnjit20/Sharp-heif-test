...
let AppController = (() => {
    ...
    (() => {
        ...
        _getTest_decorators = [(0, common_1.Get)('test')];
        _create_decorators = [(0, common_1.Post)('create'), (0, common_1.HttpCode)(200)];
        ...
        __esDecorate(_classThis, null, _getTest_decorators, { kind: "method", name: "getTest", static: false, private: false, access: { has: obj => "getTest" in obj, get: obj => obj.getTest }, metadata: _metadata }, null, _instanceExtraInitializers);
